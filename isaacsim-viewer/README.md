...
Refer to the Omniverse WebRTC Streaming Library documentation at `./node_modules/@nvidia/omniverse-webrtc-streaming-library/docs/index.html` for a detailed reference of the available streaming parameters.
...
3. Update the version of `@nvidia/omniverse-webrtc-streaming-library` in [package.json](./package.json).
4. Pull dependencies:
