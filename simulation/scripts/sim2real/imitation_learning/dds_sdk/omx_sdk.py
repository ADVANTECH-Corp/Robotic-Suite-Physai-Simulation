...
class OMXSdk:
    """OMXSdk class for DDS teleoperation and publishing robot state/images."""
    ...
    def __init__(self, env, mode: str):
        ...
        self.joint_names = ["joint1", "joint2", "joint3", "joint4", "joint5", "gripper_joint_1"]
        self.exclude_joints = []
        ...
        self._http_port = int(os.getenv("OMX_CMD_PORT", 9999))
    ...
    def get_action(self):
        ...
        action_names = ["joint1", "joint2", "joint3", "joint4", "joint5", "gripper_joint_1"]
        positions = [joint_state.get(name, 0.0) for name in action_names]

        # Clamp gripper_joint_1 to minimum 0.12 PS: 會汙染到hdf5，需要在isaaclab2lerobot.py中進行修正
        gripper_idx = action_names.index("gripper_joint_1")
        if positions[gripper_idx] < 0.12:
            positions[gripper_idx] = 0.12
        # offsets={
        #             "joint1": 0.0,
        #             "joint2": 0.12572,
        #             "joint3": 0.0,
        ...
        #             "joint5": 0.0,
        #         }
        # positions = [pos + offsets.get(name, 0.0) for pos, name in zip(positions, action_names)]
    ...
    def shutdown(self):
        ...
        for obj in [self.joint_trajectory_reader, self.joint_state_writer,
            ...
            try:
                ...
                pass
        print("OMXSdk shutdown complete")
