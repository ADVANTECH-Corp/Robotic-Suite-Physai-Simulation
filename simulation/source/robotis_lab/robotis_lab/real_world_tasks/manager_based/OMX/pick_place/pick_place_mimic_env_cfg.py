...
from .joint_pos_env_cfg import OMXBottlePickPlaceEnvCfg


@configclass
class OMXPickPlaceMimicEnvCfg(OMXBottlePickPlaceEnvCfg, MimicEnvCfg):
    """
    ...
    def __post_init__(self):
        ...
        self.subtask_configs["OMX"] = subtask_configs
